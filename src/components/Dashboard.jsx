    ...
    <div className="dashboard-container">
      ...
      <div className="row mb-4">
        <div className="col-md-3 mb-3">
          <div className="card analytics-card h-100 border-0 shadow-sm">
            <div className="card-body text-center p-4">
              <CircularProgress 
                ...
                strokeWidth={8}
              />
              <h6 className="mt-3 mb-1 fw-semibold">Success Rate</h6>
        ...
        <div className="col-md-3 mb-3">
          <div className="card analytics-card h-100 border-0 shadow-sm">
            <div className="card-body text-center p-4">
              ...
              <h6 className="mt-3 mb-1 fw-semibold">Current Streak</h6>
        ...
        <div className="col-md-3 mb-3">
          <div className="card analytics-card h-100 border-0 shadow-sm">
            <div className="card-body text-center p-4">
              ...
              <h6 className="mt-3 mb-1 fw-semibold">Best Day</h6>
        ...
        <div className="col-md-3 mb-3">
          <div className="card analytics-card h-100 border-0 shadow-sm">
            <div className="card-body text-center p-4">
              ...
              <h6 className="mt-3 mb-1 fw-semibold">Total Habits</h6>
